...
USE_COMPLEX_NODES    = _CFG.USE_COMPLEX_NODES        # V6.3 hypernœuds
COMPLEX_MAX_SIZE     = _CFG.COMPLEX_MAX_SIZE
COMPLEX_MIN_SIZE     = _CFG.COMPLEX_MIN_SIZE
COMPLEX_EXCLUDE_PAT  = _CFG.COMPLEX_EXCLUDE_PAT
DROP_FI_WITHIN_CPLX  = _CFG.DROP_FI_WITHIN_CPLX
